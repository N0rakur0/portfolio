...
// 背景色を指定した色に設定 (RGB: 218, 218, 216)
scene.background = new THREE.Color(0xDADAD8);
...
function render() {
  ...
  for (var i = 0, l = parentContainer.children.length; i < l; i++) {
    ...
    particle.userData.speed.add(diff.divideScalar(4500)); // Modify speed by a fraction of the distance to the dest
